...
void printStudentDetails(ResultSet *res)
{
...
int main()
{
    ...
    try
    {
        ...
        string sql = "SELECT OfferNo, CourseNo "
                     "FROM Offering "
                     "WHERE OfferTerm = 'SUMMER' AND FacNo IS NULL "
                     "ORDER BY OfferNo";
        res = stmt->executeQuery(sql);
        cout << "  Results:" << endl;
    ...
    try
    {
        ...
        string sql = "SELECT o.OfferNo, o.CourseNo, f.FacFirstName, f.FacLastName "
                     ...
                     "WHERE o.OfferNo = 'SPRING' AND f.FacRank = 'ASST' "
                     "ORDER BY o.OfferNo";
        res = stmt->executeQuery(sql);
        cout << "  Results:" << endl;
        bool foundOfferings = false;
    ...
    try
    {
        ...
        string sql = "INSERT INTO Student "
                     ...
                     "VALUES "
                     "('999-99-9999', 'John', 'Doe', 'Lawrence', 'KS', '66045', 'Finance', 'FR', 4.0)";
